...
@Alias("tabla_talla_peso")
public class Tabla_talla_peso implements Serializable {
	...
	public void setTalla_peso(double talla_peso){
		this.talla_peso=talla_peso;
	}
