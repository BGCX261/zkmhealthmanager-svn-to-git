/*
 * Hisc_deteccion_alt_menor_5a_10aServiceImpl.java
 * 
...
import healthmanager.modelo.dao.Hisc_deteccion_alt_menor_5a_10aDao;
...
@Service("hisc_deteccion_alt_menor_5a_10aService")
@Scope(value="singleton",proxyMode=ScopedProxyMode.TARGET_CLASS)
public class Hisc_deteccion_alt_menor_5a_10aService implements Serializable{

	@Autowired
	private ConsecutivoService consecutivoService;
	@Autowired
	private Hisc_deteccion_alt_menor_5a_10aDao hisc_deteccion_alt_menor_5a_10aDao;
	@Autowired
	...
	@Autowired
	private Test_puntuacion_figura_humanaService test_puntuacion_figura_humanaService;
	@Autowired
	...
	public void crear(
		...
		try {
			if (consultar(hisc_deteccion_alt_menor_5a_10a) != null)
				throw new Exception(
						"La historia clinica ya se encuentra en la base de datos");
			hisc_deteccion_alt_menor_5a_10aDao
					.crear(hisc_deteccion_alt_menor_5a_10a);
		} catch (Exception e) {
	...
	public void guardarDatos(Map<String, Object> datos) {
		try {
			Hisc_deteccion_alt_menor_5a_10a hisc_deteccion_alt_menor_5a_10a = (Hisc_deteccion_alt_menor_5a_10a) datos
			...
			remision_interna.setCodigo_historia(hisc_deteccion_alt_menor_5a_10a
					.getCodigo_historia());
			remision_interna.setFecha_inicio(hisc_deteccion_alt_menor_5a_10a
					.getFecha_inicial());

			Historia_clinica historia_clinica = new Historia_clinica();
			historia_clinica.setCodigo_empresa(hisc_deteccion_alt_menor_5a_10a
					.getCodigo_empresa());
			historia_clinica.setCodigo_sucursal(hisc_deteccion_alt_menor_5a_10a
					.getCodigo_sucursal());
			historia_clinica.setFecha_historia(hisc_deteccion_alt_menor_5a_10a
					.getFecha_inicial());
			...
			historia_clinica.setPrestador(hisc_deteccion_alt_menor_5a_10a
					.getCreacion_user());
			...
			if (accion.equalsIgnoreCase("registrar")) {
				...
				if (coordenadas != null) {
					for (Coordenadas_graficas cg : coordenadas) {
						cg.setCodigo_historia(hisc_deteccion_alt_menor_5a_10a
								.getCodigo_historia());
				...
				if (generalExtraService.consultar(historia_clinica) != null) {
					...
					hisc_deteccion_alt_menor_5a_10aDao
							.actualizar(hisc_deteccion_alt_menor_5a_10a);
				}
				if (coordenadas != null) {
					for (Coordenadas_graficas cg : coordenadas) {
			...
			crearConsulta(hisc_deteccion_alt_menor_5a_10a, admision,
			...
			FichaEpidemiologiaModel.guardarDatosImpresionDiagnostica(
					...
					hisc_deteccion_alt_menor_5a_10a.getCreacion_user());
			...
			if (anexo9_entidad != null) {
				...
				if (anexo9_aux != null) {
					...
					String consecutivo = consecutivoService
							.crearConsecutivo(hisc_deteccion_alt_menor_5a_10a
									.getCodigo_empresa(),
									hisc_deteccion_alt_menor_5a_10a
											.getCodigo_sucursal(),
	...
	public int actualizar(
			Hisc_deteccion_alt_menor_5a_10a hisc_deteccion_alt_menor_5a_10a) {
		try {
			return hisc_deteccion_alt_menor_5a_10aDao
					.actualizar(hisc_deteccion_alt_menor_5a_10a);
		} catch (Exception e) {
			throw new HealthmanagerException(e.getMessage(), e);
		}
	...
	public Hisc_deteccion_alt_menor_5a_10a consultar(
			Hisc_deteccion_alt_menor_5a_10a hisc_deteccion_alt_menor_5a_10a) {
		try {
			return hisc_deteccion_alt_menor_5a_10aDao
					.consultar(hisc_deteccion_alt_menor_5a_10a);
		} catch (Exception e) {
			throw new HealthmanagerException(e.getMessage(), e);
		}
	}
	...
	public int eliminar(
		...
		try {
			Historia_clinica historia_clinica = new Historia_clinica();
			historia_clinica
					.setCodigo_empresa(hisc_deteccion_alt_menor_5a_10a.getCodigo_empresa());
			historia_clinica.setCodigo_sucursal(hisc_deteccion_alt_menor_5a_10a
					.getCodigo_sucursal());
			historia_clinica.setCodigo_historia(hisc_deteccion_alt_menor_5a_10a
					.getCodigo_historia());
	...
	public List<Hisc_deteccion_alt_menor_5a_10a> listar(
			Map<String, Object> parameter) {
		try {
			return hisc_deteccion_alt_menor_5a_10aDao.listar(parameter);
		} catch (Exception e) {
			throw new HealthmanagerException(e.getMessage(), e);
		}
	}
	...
	public boolean existe(Map<String, Object> parameters) {
		return this.hisc_deteccion_alt_menor_5a_10aDao.existe(parameters);
	}
	...
	public void crearConsulta(Object historiasConsultas, Admision admision,
		...
		Hisc_deteccion_alt_menor_5a_10a hisc_deteccion_alt_menor_5a_10a = (Hisc_deteccion_alt_menor_5a_10a) historiasConsultas;
		Map map = new HashMap();
		map.put("codigo_empresa",
				hisc_deteccion_alt_menor_5a_10a.getCodigo_empresa());
		map.put("codigo_sucursal",
				hisc_deteccion_alt_menor_5a_10a.getCodigo_sucursal());
		map.put("nro_identificacion",
				hisc_deteccion_alt_menor_5a_10a.getIdentificacion());
		map.put("nro_ingreso", hisc_deteccion_alt_menor_5a_10a.getNro_ingreso());
		map.put("codigo_prestador",
				hisc_deteccion_alt_menor_5a_10a.getCreacion_user());
		map.put("codigo_dx", impresion_diagnostica.getCie_principal());
		map.put("creacion_date",
				hisc_deteccion_alt_menor_5a_10a.getCreacion_date());
		map.put("ultimo_update",
				hisc_deteccion_alt_menor_5a_10a.getUltimo_update());
		map.put("creacion_user",
				hisc_deteccion_alt_menor_5a_10a.getCreacion_user());
		map.put("ultimo_user", hisc_deteccion_alt_menor_5a_10a.getUltimo_user());
		map.put("tipo_hc", "");
