...
public class Oportunidad_consulta_pacientesAction extends ZKWindow  {

	private static Logger log = Logger
			.getLogger(Oportunidad_consulta_pacientesAction.class);
	...
	public void buscarDatos() throws Exception {
		try {
			...
			parameters.put("estado_admision", "2");
			...
			if (lbxVias_ingreso.getSelectedItems().size() > 0) {
				...
				log.debug("listado_vias"+listado_vias);
			...
			lbTotal_oportunidad.setValue(oportunidad_consulta + "");
	...
	public Listitem crearFilas(Map<String, Object> objeto, Component componente)
		...
		Date fecha_apertura = (Date) objeto.get("fecha_apertura");
		Double dif_minutos = (Double) objeto.get("dif_minutos");
		...
		*/
		...
		fila.appendChild(new Listcell(dateFormat.format(fecha_apertura) + ""));
			
		
		Double horas = (double) (dif_minutos / 60);
		Long hora_entero = (long) (dif_minutos / 60);
