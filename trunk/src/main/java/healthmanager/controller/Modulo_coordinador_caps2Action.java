...
public class Modulo_coordinador_caps2Action extends ZKWindow {

	@SuppressWarnings("unused")
	private static Logger log = Logger
			.getLogger(Modulo_coordinador_caps2Action.class);
	...
	public Toolbarbutton btnFiltro_ingreso;
	...
	public Listitem crearFilas(Object objeto, Component componente)
		...
		String ffh = "";
		String ffm = "";
		if (admision.getFecha_ingreso() != null
				&& admision.getFecha_atencion() != null) {
			long resultado = restarFecha(admision.getFecha_ingreso(),
					admision.getFecha_atencion());
			ffh = String.valueOf((resultado) / 60);
			ffm = String.valueOf((resultado) % 60);
		}
		...
		if (admision.getFecha_ingreso() != null
			...
			restarFecha(admision.getFecha_ingreso(),
					admision.getFecha_atencion());
			fila.appendChild(new Listcell(ffh + "H" + " y " + ffm + "mts"));
		} else {
			fila.appendChild(new Listcell(""));
		}
