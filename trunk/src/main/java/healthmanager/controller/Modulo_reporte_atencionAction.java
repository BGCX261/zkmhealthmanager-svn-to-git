...
public class Modulo_reporte_atencionAction extends ZKWindow {
	...
	Integer total_control = 0, total_primera = 0;
...
//	private Integer paginacion = 20;
	...
	private void cargarVias(Listbox listbox) {
		...
		for (Elemento elemento : elementos) {
			if (elemento.getCodigo().equals("2")
					|| elemento.getCodigo().equals("6")
					|| elemento.getCodigo().equals("7")
					|| elemento.getCodigo().equals("8")
					|| elemento.getCodigo().equals("9")
					|| elemento.getCodigo().equals("10")
					|| elemento.getCodigo().equals("11")
					|| elemento.getCodigo().equals("12")
					|| elemento.getCodigo().equals("13")
					|| elemento.getCodigo().equals("14")
					|| elemento.getCodigo().equals("17")
					|| elemento.getCodigo().equals("23")
	...
	public void buscarDatos() throws Exception {
		try {
			...
			/*
			 * if (filtrar_centro) { parameters.put("codigo_centro",
			...
			if (centro_atencion_session != null) {
				centro = centro_atencion_session.getCodigo_centro();
				parameters.put("centro_atencion", centro);
			}
			...
			if (lbxVias_ingreso.getSelectedItems().size() > 0) {
				...
				// log.info("lista de vias ingreso>>>>>>>>>>>" + listado_vias);
			}
	...
	public Listitem crearFilas(Object objeto, Component componente)
		...
		if (admision.getAtendida()) {
			if (admision.getPrimera_vez().equalsIgnoreCase("S")) {
				total_primera += 1;
			} else {
				total_control += 01;
			}
