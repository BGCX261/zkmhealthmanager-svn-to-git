...
public class Modulo_administradorAction extends ZKWindow {
	...
	public Listitem crearFilas(Object objeto, Component componente)
		...
		if (admision.getFecha_atencion() != null) {
			...
			// log.info("fecha_actual" + fecha_actual);
			resultado = restarFecha(admision.getFecha_ingreso(), fecha_actual);
		}
		...
		fila.appendChild(new Listcell(
				(admision.getFecha_atencion() != null) ? dateFormat
