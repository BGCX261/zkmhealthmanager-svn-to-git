...
public class Modulo_coordinador_servicioAction extends ZKWindow {

	@SuppressWarnings("unused")
	private static Logger log = Logger
			.getLogger(Modulo_coordinador_servicioAction.class);
	...
	public void inicializarContenedorPaginas() throws Exception {
		...
		if (admision_seleccionada != null) {
			...
			if (via_ingreso.equals(IVias_ingreso.FORMULARIO_TRIAGE)) {
				...
				mostrar_ordenes_medicas = true;
				mostrar_notas_enfermeria = true;
			} else if (via_ingreso.equals(IVias_ingreso.CONSULTA_EXTERNA) || via_ingreso.equals(IVias_ingreso.CONSULTA_ESPECIALIZADA)) {
				...
				}else if(via_ingreso.equals(IVias_ingreso.CONSULTA_ESPECIALIZADA)){
					tabboxContendor
