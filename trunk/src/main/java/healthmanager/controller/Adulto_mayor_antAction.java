 ...
 *
 */
public class Adulto_mayor_antAction  extends ZKWindow{
	
//	private static Logger log = Logger.getLogger(Adulto_mayor_antAction.class);
	...
	@View private Row rowFemenino1;
	@View private Row rowMasculino0;
	...
	private void modificarPorSexo(){
		...
		if(!sexo.isEmpty()){
			...
			rowFemenino1.setVisible(es_femenino);
			rowMasculino0.setVisible(!es_femenino);
		}
	}
