...
public class ProcedimientosAction extends ZKWindow {
	...
	private static Logger log = Logger.getLogger(ProcedimientosAction.class);
	...
	@View
	private Longbox longboxId_procedimiento;
	...
	@View
	private Textbox tbxTipoProcedimiento;
	@View
	...
	private void parametrizarbandbox() {
		parametrizarBandboxTipoprocedimiento();
	}

	private void parametrizarBandboxTipoprocedimiento() {
	...
	public void guardarDatos() throws Exception {
		try {
			...
			if (validarForm()) {
				...
				procedimiento.setId_procedimiento(longboxId_procedimiento.getValue() != null ? longboxId_procedimiento.getValue() : 0L);
				...
				procedimiento.setTipo_procedimiento(tbxTipoProcedimiento.getValue());
				...
				procedimiento.setFinalidad_procedimiento("1");
	...
	public void mostrarDatos(Object obj) throws Exception {
		...
		try {
			longboxId_procedimiento.setValue(procedimiento.getId_procedimiento());
			...
			tbxTipoProcedimiento.setValue(procedimiento.getTipo_procedimiento());
