...
public abstract class ZKWindow extends Window implements AfterCompose,
        WindowStandar {
                ...
                this.addEventListener(Events.ON_CREATE,
                        new EventListener<Event>() {
                            ...
                            public void onEvent(Event arg0) throws Exception {
                                ((IHistoria_generica) ZKWindow.this)
                                .initHistoria();
                            }
                        });
    ...
    private void initComponents(Component component) throws Exception {
        ...
        for (Field field : fields) {
            ...
            /**
             * Inyeccion de servicios de zkwindow
			 *
             */
            Service service = field.getType().getAnnotation(Service.class);
            if (service != null) {
				// //log.info("@initComponents cargando servicio " +
                // service.value());
                field.setAccessible(true);
                field.set(component,
                        getServiceLocator().getServicio(field.getType()));
            }
        }
