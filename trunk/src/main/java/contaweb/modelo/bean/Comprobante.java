...
public class Comprobante{
	...
	private  String consecutivo_tabla;
	...
	public Comprobante(
		...
		String delete_user,
		boolean sistema,
		String consecutivo_tabla){
		this.codigo_empresa = codigo_empresa;
		this.codigo_sucursal = codigo_sucursal;
		this.codigo = codigo;
		this.nombre = nombre;
		this.tipo_dct = tipo_dct;
	...
	public void setTipo_dct(String tipo_dct){
		this.tipo_dct=tipo_dct;
	}
	...
	public void setConsecutivo_tabla(String consecutivo_tabla) {
		this.consecutivo_tabla = consecutivo_tabla;
	}
	
	public String getConsecutivo_tabla() {
		return consecutivo_tabla;
	}
}
