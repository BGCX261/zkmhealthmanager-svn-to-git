...
public class IntercerptorPesoEdad2a5Anios extends InterceptorSelector implements IInterceptorGrafica {
	private double peso;
	private ESexo sexo;
	private double talla;
	private Timestamp fecha_nacimineto;
	
	public IntercerptorPesoEdad2a5Anios(ESexo sexo) {
		super();
		this.sexo = sexo;
	}
	
	public IntercerptorPesoEdad2a5Anios() {}
	...
	public void mostrarGrafica(final List<RespuestaInt> valores, ZKWindow zkWindow, ESexo sexo){
		...
		String mapper_grafica = sexo == ESexo.FEMENINO ? "/images/graficas/f/peso_edad_2_5anios.mapper" : "/images/graficas/m/peso_edad_2_a_5.mapper"; 
...
//		graficaMacro.setShowBackLine(true);
		...
		mostrarVentanaParaUsuario(graficaMacro, zkWindow, "Grafica de Peso para edad de 2 a 5 Anios");
	}
	...
	public void mostrarTabla(ESexo sexo, ZKWindow zkWindow) {
		...
		mostrarVentanaParaUsuario(tablaMacro, zkWindow, "Tabla de Peso para edad de 2 a 5 Anios");
	}
