...
public class InterceptorImcEdad2a5 extends InterceptorSelector implements
		IInterceptorGrafica {
	...
	public void mostrarGrafica(List<RespuestaInt> valores, ZKWindow zkWindow,
		...
		String mapper_grafica = sexo == ESexo.FEMENINO ? "/images/graficas/f/bmi_ninias_2_5.mapper" : "/images/graficas/m/bmi_edad_2_5.mapper"; 
...
//		graficaMacro.setShowBackLine(true);
		...
		graficaMacro.setFocoY(489d);
		graficaMacro.setGroups(3);
		graficaMacro.setMapper(mapper_grafica);
		graficaMacro.setLengthSectX(36);
		graficaMacro.setLengthSectY(101);
		...
		mostrarVentanaParaUsuario(graficaMacro, zkWindow, "Grafica de IMC para edad de 2 a 5 Anios");
	}
	...
	private List<RespuestaInt> validarLista(List<RespuestaInt> valores, PainterMoldG painterMoldG) { 
		...
		for (RespuestaInt respuestaInt : valores) {
			 ...
			 respuestaIntSend.setY(((respuestaInt.getY() - 11) * 10) - 3);
	...
	public void mostrarTabla(ESexo sexo, ZKWindow zkWindow) {
		...
		mostrarVentanaParaUsuario(tablaMacro, zkWindow, "Tabla de IMC para edad de 2 a 5 Anios");
	}
}
