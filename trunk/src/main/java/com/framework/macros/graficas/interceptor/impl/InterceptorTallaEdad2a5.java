...
public class InterceptorTallaEdad2a5 extends InterceptorSelector implements
		IInterceptorGrafica {
	...
	public RespuestaInt getResultado() {
		if(validar()){
			...
			tabla_anios_meses.setEdad_inicial(2);
	...
	public void mostrarGrafica(List<RespuestaInt> valores, ZKWindow zkWindow,
		...
		String mapper_grafica = sexo == ESexo.FEMENINO ? "/images/graficas/f/talla_edad_2_5.mapper" : "/images/graficas/m/talla_edad_2_5.mapper"; 
...
//		graficaMacro.setShowBackLine(true);
		...
		mostrarVentanaParaUsuario(graficaMacro, zkWindow, "Grafica de Talla para edad de 2 a 5 Anios");
	}
...
//			 double yTemp = respuestaInt.getY(); // por que el valor es cambiantes
			 ...
			 respuestaIntSend.setY(((respuestaInt.getY() - 76)));
			 respuestaIntSend.setX(((respuestaInt.getX() - 24)));
	...
	public void mostrarTabla(ESexo sexo, ZKWindow zkWindow) {
		...
		mostrarVentanaParaUsuario(tablaMacro, zkWindow, "Tabla de Talla para edad de 2 a 5 Anios");
	}
