...
public class ComunicadorTriage extends ComunicadorAbstract {
	...
	protected void montarCabecera(Columns columns) {
		...
		columns.appendChild(getColumn("Nivel triage", "100px"));
		columns.appendChild(getColumn("Fecha triage", "120px"));
	...
	protected void crearFilas(Object dato, Row row) {
		...
		row.appendChild(new Label(fecha_atencion != null ? dateFormat_completa.format(fecha_atencion) : ""));
