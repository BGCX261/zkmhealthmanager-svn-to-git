...
public class ServiceLocatorWeb {
    ...
    private static ServiceLocatorWeb instance;

    private ServiceLocatorWeb() {
    }

    public static Usuarios getUsuarios(HttpServletRequest request) {
        Usuarios usuarios = null;
        Object object = request.getSession().getAttribute(IParametrosSesion.PARAM_USUARIO);
    ...
    private Object lookupService(String serviceBeanName) {
        return SpringUtil.getBean(serviceBeanName);
    }
     ...
     * @return
     */
    public static ServiceLocatorWeb getInstance() {
        if (instance == null) {
            instance = new ServiceLocatorWeb();
        }
        return instance;
    }
