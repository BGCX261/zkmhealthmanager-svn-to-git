...
public class Laboratorios_webAction extends ZKWindow {

	private static Logger log = Logger
			.getLogger(Laboratorios_webAction.class);
	...
	public void init() {
		...
		bandboxPaciente.setButtonVisible(false);
	...
	private void cargarInformacionPacinente() {
		...
		if(paciente != null){				
			bandboxPaciente.setText("" + paciente.getNro_identificacion());
			tbxInfoPaciente.setText(""+ paciente.getNombreCompleto());
		...
		bandboxPaciente
				.setBandboxRegistrosIMG(new BandboxRegistrosIMG<Paciente>() {
					...
					public List<Paciente> listarRegistros(String valorBusqueda,
						...
						return Laboratorios_webAction.this
